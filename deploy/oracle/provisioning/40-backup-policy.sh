...
#
# dial-hermes-control and vekl-worker are NOT touched without --include-hermes.
...
if [[ "$INCLUDE_HERMES" == true ]]; then
  ...
  log "         dial-hermes-control and vekl-worker. That is a change to protected"
  ...
  TARGETS+=("dial-hermes-control" "vekl-worker")
fi
