...
VAN_PUB="${VAN_TRADING_CORE_WG_PUBLIC_KEY:-}"
# Optional: the migration source (dial-hermes-control, a separate A1) until it is retired.
SRC_PUB="${HERMES_SOURCE_WG_PUBLIC_KEY:-}"
...
[Peer]
# old-dial-hermes-control: migration source, removed when retired and terminated
PublicKey = $SRC_PUB
