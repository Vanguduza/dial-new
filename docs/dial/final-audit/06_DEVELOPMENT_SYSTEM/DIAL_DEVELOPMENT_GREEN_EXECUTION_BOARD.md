...
- [ ] P7.07 Run Project Truth verifier against closure commit.
...
- [ ] P7.10 Capture structured per-test receipts and before/after SHA evidence.
...
- [ ] P8.07 Commit closure changes using authorized/signed policy.
