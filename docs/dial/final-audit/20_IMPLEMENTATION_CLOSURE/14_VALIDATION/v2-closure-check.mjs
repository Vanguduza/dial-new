...
const features=load("06_DEVELOPMENT_SYSTEM/ready_to_copy/agent-system/registries/FEATURE_REGISTRY.json");
const facets=load("11_FEATURE_REALIZATION/SUBFEATURE_FUNCTION_REGISTRY.json");
const realization=load("11_FEATURE_REALIZATION/FEATURE_REALIZATION_REGISTRY.json");
const frcs=load("20_IMPLEMENTATION_CLOSURE/01_FEATURE_CONTRACTS/FEATURE_IMPLEMENTATION_CONTRACT_REGISTRY.json");
const ev=load("20_IMPLEMENTATION_CLOSURE/02_EVENTUALITY_CONTRACTS/EXECUTABLE_EVENTUALITY_CONTRACT_REGISTRY.json");
const donors=load("20_IMPLEMENTATION_CLOSURE/03_DONOR_CLOSURE/DONOR_QUALIFICATION_STATUS.json");
const nfr=load("20_IMPLEMENTATION_CLOSURE/04_NFR/NFR_BUDGET_REGISTRY.json");
const envs=load("20_IMPLEMENTATION_CLOSURE/05_DEPLOYMENT/ENVIRONMENT_REGISTRY.json");
const blockers=load("20_IMPLEMENTATION_CLOSURE/06_ACTIVATION/ACTIVATION_BLOCKER_REGISTRY.json");
const ops=load("20_IMPLEMENTATION_CLOSURE/07_OPERATING_MODEL/OPERATIONAL_RESPONSIBILITY_REGISTRY.json");
const md=load("20_IMPLEMENTATION_CLOSURE/08_MASTER_DATA/MASTER_DATA_REGISTRY.json");
const branches=load("20_IMPLEMENTATION_CLOSURE/10_ACTIVATION_CONFIG/BRANCH_ACTIVATION_REGISTRY.json");
const repo=load("20_IMPLEMENTATION_CLOSURE/11_REPOSITORY_ALIGNMENT/REPOSITORY_BOOTSTRAP_CHECKLIST.json");
...
const textFiles=[
 "00_MASTER/DIAL_V2_IMPLEMENTATION_CLOSURE_CANON.md",
 "13_PROMPTS/DIAL_MASTER_DEVELOPMENT_PROMPT_v2.md",
 "20_IMPLEMENTATION_CLOSURE/11_REPOSITORY_ALIGNMENT/ACTUAL_GITHUB_REPOSITORY_ALIGNMENT_AUDIT.md"
];
