...
const INSTALL = new Set(['APT_PINNED', 'APT_SIGNED_REPO', 'NPM_EXACT', 'RELEASE_TARBALL_SHA256', 'BINARY_TARBALL_SHA256', 'SOURCE_ARCHIVE_SHA256', 'INSTALLER_SHA256', 'REPO_PINNED_SCRIPT', 'REPO_LOCAL', 'PREINSTALLED', 'PROVIDER_MANAGED', 'MANUAL', 'NONE']);
