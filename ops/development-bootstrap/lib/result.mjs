...
export function check({ id, domain, title, status, criticality = CRITICALITY.REQUIRED, evidence = {}, remediation = null, severity = null, gate = null, detail = null }) {
  ...
  return Object.freeze({ id, domain, title, status, criticality, evidence, remediation, severity, gate, detail });
}
