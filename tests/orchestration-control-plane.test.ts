...
describe('manager health and lease routing', () => {
  it('requires both HEALTHY state and requested/resolved model identity for a hard-pinned manager', () => {
...
describe('feature resolution', () => {
  it('prefers an explicit Feature ID in the incoming user turn over cached active work', () => {
    const repo = makeRepo();
