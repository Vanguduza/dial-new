...
export default defineConfig({
  test: {
    include: ['tests/**/*.test.ts', 'tests/orchestration-control-plane.test.mjs', 'tests/orchestration-operations-plane.test.mjs', 'tests/orchestration-chat-control.test.mjs', 'tests/orchestration-vekl.test.mjs', 'tests/orchestration-vekl-resources.test.mjs'],
