...
export default defineConfig({
  test: {
    include: ['tests/**/*.test.ts', 'tests/orchestration-control-plane.test.mjs', 'tests/orchestration-operations-plane.test.mjs', 'tests/orchestration-chat-control.test.mjs', 'tests/orchestration-vekl.test.mjs', 'tests/orchestration-vekl-resources.test.mjs', 'tests/orchestration-process-capture.test.mjs', 'tests/orchestration-process-tree.test.js', 'tests/orchestration-operator-status.test.mjs', 'tests/orchestration-operator-gateway.test.mjs', 'tests/orchestration-haif.test.mjs', 'tests/project-truth-authority.test.mjs', 'tests/project-truth-local.test.mjs', 'tests/orchestration-vekl-graph-v2.test.mjs', 'tests/orchestration-adaptive-execution.test.mjs', 'tests/orchestration-vekl-n8n-corpus.test.mjs'],
