...
function normalizeReview(review){
  ...
  const critical=Array.isArray(review?.critical_defects)?review.critical_defects.map(String):['ART_DIRECTOR_REVIEW_MALFORMED'];
  ...
  return {...review,score,critical_defects:critical,corrections,verdict};
}
