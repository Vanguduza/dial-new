...
Rev 3 adds a persistent premium visual calibration envelope derived from the user-approved My Health reference set. Each screen receives a lead designer/compiler pass, a separate 100-point art-director review, and a repair/final-audit pass when the score is below 90 or a critical defect is present. The benchmark and anti-patterns are canonical in `docs/dial/health/DIAL_HEALTH_PREMIUM_SCREEN_QUALITY_STANDARD_REV3.md`.
