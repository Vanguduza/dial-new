...
const SHELL_AND_TOOLING = new Set([
  ...
  'tests/orchestration-operator-gateway.test.mjs',
  'tests/orchestration-haif.test.mjs',
  'tests/orchestration-operator-status.test.mjs',
  'tests/orchestration-process-capture.test.mjs',
