...
import {formatOracleStatusContext} from "./oracle-status-context.mjs";
...
const oracle=formatOracleStatusContext(readOracleOperatorStatus({repoDir:process.env.CLAUDE_PROJECT_DIR||process.cwd()}));
const ctx=[
